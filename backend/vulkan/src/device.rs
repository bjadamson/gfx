...
impl d::Device<R> for Device {
    ...
    fn create_sampler(&mut self, _: t::SamplerInfo) -> handle::Sampler<R> {
        unimplemented!()
    }
    ...
    fn reset_fences(&mut self, _fences: &[&handle::Fence<R>]) {
        unimplemented!()
    }

    fn wait_for_fences(&mut self,
                       _fences: &[&handle::Fence<R>],
                       _wait: d::WaitFor,
                       _timeout_ms: u32)
                       -> bool {
        unimplemented!()
